...
<body>
    <div class="container">
        <!-- Header -->
        <div class="header">
            <img src="https://res.cloudinary.com/dm0lrdhi5/image/upload/v1711234567/logo_folika_cbu3qs.png" alt="Logo">
        </div>
        <hr>
        ...
        <div class="content">
            ...
            <p>Salam Hormat,<br>Tim Folika</p>
        </div>
        ...
        <!-- Footer -->
        <div class="footer">
            <p>&copy; 2025 Folika, All rights reserved</p>
        </div>
    </div>
</body>
</html>
